...
class AudioAgent(BaseAgent):
    ...
    async def _analyze_segment(self, segment_id: str) -> dict | None:
        ...
        features = await self._extract_audio_features(source_path, segment.start, segment.end, segment_id)
    ...
    async def _extract_audio_features(self, video_path: str, start_time: float, end_time: float, segment_id: str) -> dict | None:
